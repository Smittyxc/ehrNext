  ...
  return ( 
    <fieldset className="grid lg:grid-cols-4 grid-cols-2 border p-4 rounded w-full gap-4">
        ...
        <div className=''>
          ...
          <Input id="genericName" {...register('genericName')} className="" />
        ...
        <div className=''>
          ...
          <Input id="brandName" {...register('brandName')} className="" />
        ...
        <div>
          ...
          <Input id="strength" type="number" {...register('strength')} className="" />
        ...
        <div>
          ...
          <select id="strengthUnit" {...register('strengthUnit')} className="border border-gray-200 h-9 rounded-md px-2 shadow-xs w-full text-xs">
